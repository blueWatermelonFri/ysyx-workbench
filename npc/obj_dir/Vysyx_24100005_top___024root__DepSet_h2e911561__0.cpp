...
void Vysyx_24100005_top___024root___ico_sequent__TOP__0(Vysyx_24100005_top___024root* vlSelf);

void Vysyx_24100005_top___024root___eval_ico(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___eval_ico\n"); );
    // Body
    if (vlSelf->__VicoTriggered.at(0U)) {
        Vysyx_24100005_top___024root___ico_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[1U] = 1U;
    }
}

void Vysyx_24100005_top___024root___eval_act(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___eval_act\n"); );
}

VL_INLINE_OPT void Vysyx_24100005_top___024root___nba_sequent__TOP__0(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___nba_sequent__TOP__0\n"); );
    // Init
    CData/*4:0*/ __Vdlyvdim0__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0;
    __Vdlyvdim0__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 = 0;
    IData/*31:0*/ __Vdlyvval__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0;
    __Vdlyvval__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 = 0;
    CData/*0:0*/ __Vdlyvset__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0;
    __Vdlyvset__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 = 0;
    // Body
    __Vdlyvset__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 = 0U;
    if (vlSelf->ysyx_24100005_top__DOT__wen) {
        __Vdlyvval__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 
            = vlSelf->ysyx_24100005_top__DOT__wdata;
        __Vdlyvset__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 = 1U;
        __Vdlyvdim0__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0 
            = (0x1fU & (vlSelf->inst >> 7U));
    }
    vlSelf->PC = ((IData)(vlSelf->rst) ? 0x80000000U
                   : vlSelf->ysyx_24100005_top__DOT__DPC);
    if (__Vdlyvset__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0) {
        vlSelf->ysyx_24100005_top__DOT__RegFile__DOT__rf[__Vdlyvdim0__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0] 
            = __Vdlyvval__ysyx_24100005_top__DOT__RegFile__DOT__rf__v0;
    }
...
VL_INLINE_OPT void Vysyx_24100005_top___024root___nba_sequent__TOP__1(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___nba_sequent__TOP__1\n"); );
    // Body
    if (vlSelf->ysyx_24100005_top__DOT__wen) {
...
void Vysyx_24100005_top___024root___eval_nba(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___eval_nba\n"); );
    // Body
    if (vlSelf->__VnbaTriggered.at(0U)) {
        Vysyx_24100005_top___024root___nba_sequent__TOP__0(vlSelf);
        vlSelf->__Vm_traceActivity[2U] = 1U;
        Vysyx_24100005_top___024root___nba_sequent__TOP__1(vlSelf);
    }
}

void Vysyx_24100005_top___024root___eval_triggers__ico(Vysyx_24100005_top___024root* vlSelf);
#ifdef VL_DEBUG
VL_ATTR_COLD void Vysyx_24100005_top___024root___dump_triggers__ico(Vysyx_24100005_top___024root* vlSelf);
#endif  // VL_DEBUG
void Vysyx_24100005_top___024root___eval_triggers__act(Vysyx_24100005_top___024root* vlSelf);
#ifdef VL_DEBUG
...
void Vysyx_24100005_top___024root___eval(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___eval\n"); );
    // Init
    ...
    while (__VicoContinue) {
        __VicoContinue = 0U;
        Vysyx_24100005_top___024root___eval_triggers__ico(vlSelf);
        if (vlSelf->__VicoTriggered.any()) {
            __VicoContinue = 1U;
            if (VL_UNLIKELY((0x64U < vlSelf->__VicoIterCount))) {
#ifdef VL_DEBUG
                Vysyx_24100005_top___024root___dump_triggers__ico(vlSelf);
#endif
                VL_FATAL_MT("/home/myuser/ysyx/ysyx-workbench/npc/vsrc/top.v", 2, "", "Input combinational region did not converge.");
            }
            vlSelf->__VicoIterCount = ((IData)(1U) 
                                       + vlSelf->__VicoIterCount);
            Vysyx_24100005_top___024root___eval_ico(vlSelf);
        }
    }
    __VnbaIterCount = 0U;
    __VnbaContinue = 1U;
    while (__VnbaContinue) {
        ...
        while (vlSelf->__VactContinue) {
            ...
            Vysyx_24100005_top___024root___eval_triggers__act(vlSelf);
            if (vlSelf->__VactTriggered.any()) {
                vlSelf->__VactContinue = 1U;
                if (VL_UNLIKELY((0x64U < vlSelf->__VactIterCount))) {
#ifdef VL_DEBUG
                    Vysyx_24100005_top___024root___dump_triggers__act(vlSelf);
#endif
                    VL_FATAL_MT("/home/myuser/ysyx/ysyx-workbench/npc/vsrc/top.v", 2, "", "Active region did not converge.");
                }
                vlSelf->__VactIterCount = ((IData)(1U) 
                                           + vlSelf->__VactIterCount);
                __VpreTriggered.andNot(vlSelf->__VactTriggered, vlSelf->__VnbaTriggered);
                vlSelf->__VnbaTriggered.set(vlSelf->__VactTriggered);
                Vysyx_24100005_top___024root___eval_act(vlSelf);
            }
        }
...
#ifdef VL_DEBUG
                Vysyx_24100005_top___024root___dump_triggers__nba(vlSelf);
#endif
                VL_FATAL_MT("/home/myuser/ysyx/ysyx-workbench/npc/vsrc/top.v", 2, "", "NBA region did not converge.");
            }
            __VnbaIterCount = ((IData)(1U) + __VnbaIterCount);
            Vysyx_24100005_top___024root___eval_nba(vlSelf);
        }
    }
}

#ifdef VL_DEBUG
void Vysyx_24100005_top___024root___eval_debug_assertions(Vysyx_24100005_top___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vysyx_24100005_top__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vysyx_24100005_top___024root___eval_debug_assertions\n"); );
    // Body
