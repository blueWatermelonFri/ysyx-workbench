...
# 25 "src/engine/interpreter/init.c" 3 4
                           _Bool 
# 25 "src/engine/interpreter/init.c"
                                *success);

void test_cmd_p(){
    FILE *file = fopen("/home/myuser/ysyx/ysyx-workbench/nemu/tools/gen-expr/input", "r");
    if (!file) {
        perror("无法打开文件");
        return;
    }

    char line[65536 + 1024];
    char A[11] = "";
    char B[65536 + 1024] = "";
...
# 42 "src/engine/interpreter/init.c" 3 4
         _Bool 
# 42 "src/engine/interpreter/init.c"
              *suceess = 
# 42 "src/engine/interpreter/init.c" 3 4
                         ((void *)0)
# 42 "src/engine/interpreter/init.c"
                             ;
          suceess = (
# 43 "src/engine/interpreter/init.c" 3 4
                     _Bool 
# 43 "src/engine/interpreter/init.c"
                          *)malloc(sizeof(
# 43 "src/engine/interpreter/init.c" 3 4
                                          _Bool
# 43 "src/engine/interpreter/init.c"
          ...
          *suceess = 
# 44 "src/engine/interpreter/init.c" 3 4
                    0
# 44 "src/engine/interpreter/init.c"
                         ;

          char * endptr ;
          word_t real = (word_t) strtoul(A, &endptr, 0);
          word_t res = expr(B, suceess);

          if(real != res){
            fprintf(
# 51 "src/engine/interpreter/init.c" 3 4
                   stderr
# 51 "src/engine/interpreter/init.c"
                         , "real is %u, res is %u\n", real, res);
          }
      }
    }
