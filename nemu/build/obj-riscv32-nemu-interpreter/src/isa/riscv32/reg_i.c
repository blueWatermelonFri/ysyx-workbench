...
# 51 "src/isa/riscv32/reg.c" 3 4
                                     _Bool 
# 51 "src/isa/riscv32/reg.c"
                                          *success) {

    for (size_t i = 0; register_map[i].name != 
...
# 53 "src/isa/riscv32/reg.c"
        ...
        if (strcmp(s, register_map[i].name) == 0) {
            *success = 
# 55 "src/isa/riscv32/reg.c" 3 4
                      1
# 55 "src/isa/riscv32/reg.c"
                          ;
    ...
    *success = 
# 60 "src/isa/riscv32/reg.c" 3 4
              0
# 60 "src/isa/riscv32/reg.c"
                   ;
