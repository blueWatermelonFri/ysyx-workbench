...
# 17 "src/isa/riscv32/difftest/../local-include/reg.h"
...
# 20 "src/isa/riscv32/difftest/dut.c" 3 4
_Bool 
# 20 "src/isa/riscv32/difftest/dut.c"
    isa_difftest_checkregs(CPU_state *ref_r, vaddr_t pc) {
  return 
# 21 "src/isa/riscv32/difftest/dut.c" 3 4
        0
# 21 "src/isa/riscv32/difftest/dut.c"
             ;
}
