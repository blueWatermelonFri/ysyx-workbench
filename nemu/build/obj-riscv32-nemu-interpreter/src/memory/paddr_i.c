...
# 20 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/host.h" 2
...
# 1 "/home/myuser/ysyx/ysyx-workbench/nemu/include/device/mmio.h" 1
# 17 "/home/myuser/ysyx/ysyx-workbench/nemu/include/device/mmio.h"
...
# 50 "src/memory/paddr.c" 3 4
 "x" 
# 50 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 50, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); do { extern FILE* log_fp; extern 
# 50 "src/memory/paddr.c" 3 4
 _Bool 
# 50 "src/memory/paddr.c"
...
# 50 "src/memory/paddr.c" 3 4
 "x" 
# 50 "src/memory/paddr.c"
 "]" "\33[0m" "\n", "src/memory/paddr.c", 50, __func__, ((paddr_t)0x80000000), ((paddr_t)0x80000000 + 0x8000000 - 1)); fflush(log_fp); } } while (0); } while (0);
}
