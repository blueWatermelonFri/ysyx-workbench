...
static void welcome() {
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 32, __func__, "22:44:12", "Oct 12 2024"); do { extern FILE* log_fp; extern _Bool log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "Build time: %s, %s" "\33[0m" "\n", "src/monitor/monitor.c", 32, __func__, "22:44:12", "Oct 12 2024"); fflush(log_fp); } } while (0); } while (0);
