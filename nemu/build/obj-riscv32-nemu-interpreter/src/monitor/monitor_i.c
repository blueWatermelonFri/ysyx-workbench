...
# 40 "src/monitor/monitor.c" 2


# 41 "src/monitor/monitor.c"
void sdb_set_batch_mode();

static char *log_file = 
# 43 "src/monitor/monitor.c" 3 4
                       ((void *)0)
...
# 55 "src/monitor/monitor.c"
 "fp"
# 55 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 55, __extension__ __PRETTY_FUNCTION__); }))
# 55 "src/monitor/monitor.c"
 ; } } while (0);
...
# 57 "src/monitor/monitor.c"
  ...
  do { printf("\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 60, __func__, img_file, size); do { extern FILE* log_fp; extern 
# 60 "src/monitor/monitor.c" 3 4
 _Bool 
# 60 "src/monitor/monitor.c"
 log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "The image is %s, size = %ld" "\33[0m" "\n", "src/monitor/monitor.c", 60, __func__, img_file, size); fflush(log_fp); } } while (0); } while (0);
...
# 64 "src/monitor/monitor.c"
 "ret == 1"
# 64 "src/monitor/monitor.c" 3 4
 , "src/monitor/monitor.c", 64, __extension__ __PRETTY_FUNCTION__); }))
# 64 "src/monitor/monitor.c"
                 ;
...
# 77 "src/monitor/monitor.c"
  ...
  int o;
  while ( (o = getopt_long(argc, argv, "-bhl:d:p:", table, 
