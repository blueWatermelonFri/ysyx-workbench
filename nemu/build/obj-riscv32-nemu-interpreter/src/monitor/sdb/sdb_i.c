...
#define HEXVALUE(c) (((c) >= 'a' && (c) <= 'f') ? (c)-'a'+10 : (c) >= 'A' && (c) <= 'F' ? (c)-'A'+10 : (c)-'0')
...
# 21 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/vaddr.h"
...
# 22 "src/monitor/sdb/sdb.h" 2

word_t expr(char *e, 
# 23 "src/monitor/sdb/sdb.h" 3 4
                    _Bool 
# 23 "src/monitor/sdb/sdb.h"
                         *success);
...
# 32 "src/monitor/sdb/sdb.c"
  ...
  if (line_read) {
    free(line_read);
    line_read = 
# 36 "src/monitor/sdb/sdb.c" 3 4
               ((void *)0)
# 36 "src/monitor/sdb/sdb.c"
                   ;
  }
...
static int cmd_info(char *args) {
  ...
  if(args == 
# 62 "src/monitor/sdb/sdb.c" 3 4
            ((void *)0)
# 62 "src/monitor/sdb/sdb.c"
                ){
...
static int cmd_si(char *args) {
  ...
  if(args == 
# 83 "src/monitor/sdb/sdb.c" 3 4
            ((void *)0)
# 83 "src/monitor/sdb/sdb.c"
                ) steps = 1;
...
# 96 "src/monitor/sdb/sdb.c"
 "str_len != NULL && str_addr != NULL"
# 96 "src/monitor/sdb/sdb.c" 3 4
 , "src/monitor/sdb/sdb.c", 96, __extension__ __PRETTY_FUNCTION__); }))
# 96 "src/monitor/sdb/sdb.c"
                                            ;
...
# 99 "src/monitor/sdb/sdb.c"
 "strlen(str_addr) == 10"
# 99 "src/monitor/sdb/sdb.c" 3 4
 , "src/monitor/sdb/sdb.c", 99, __extension__ __PRETTY_FUNCTION__); }))
# 99 "src/monitor/sdb/sdb.c"
                               ;
...
# 105 "src/monitor/sdb/sdb.c"
 "addr >= 0x80000000"
# 105 "src/monitor/sdb/sdb.c" 3 4
 , "src/monitor/sdb/sdb.c", 105, __extension__ __PRETTY_FUNCTION__); }))
# 105 "src/monitor/sdb/sdb.c"
                            ;
...
# 113 "src/monitor/sdb/sdb.c"
 "len > 0"
# 113 "src/monitor/sdb/sdb.c" 3 4
 , "src/monitor/sdb/sdb.c", 113, __extension__ __PRETTY_FUNCTION__); }))
# 113 "src/monitor/sdb/sdb.c"
                ;

  if (endptr == str_len) {
        fprintf(
# 116 "src/monitor/sdb/sdb.c" 3 4
               stderr
# 116 "src/monitor/sdb/sdb.c"
                     , "No digits were found\n");
        exit(
...
static int cmd_w(char *args) {
  ...
  if( args == 
# 144 "src/monitor/sdb/sdb.c" 3 4
             ((void *)0)
# 144 "src/monitor/sdb/sdb.c"
                 ){
...
# 216 "src/monitor/sdb/sdb.c"
    ...
    char *cmd = strtok(str, " ");
    if (cmd == 
# 221 "src/monitor/sdb/sdb.c" 3 4
              ((void *)0)
# 221 "src/monitor/sdb/sdb.c"
                  ) { continue; }
