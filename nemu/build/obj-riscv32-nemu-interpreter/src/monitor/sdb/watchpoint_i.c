...
static WP *head = 
# 31 "src/monitor/sdb/watchpoint.c" 3 4
                 ((void *)0)
# 31 "src/monitor/sdb/watchpoint.c"
                     , *free_ = 
# 31 "src/monitor/sdb/watchpoint.c" 3 4
                                ((void *)0)
# 31 "src/monitor/sdb/watchpoint.c"
...
# 38 "src/monitor/sdb/watchpoint.c" 3 4
                                       ((void *)0) 
# 38 "src/monitor/sdb/watchpoint.c"
                                            : &wp_pool[i + 1]);
  }

  head = 
# 41 "src/monitor/sdb/watchpoint.c" 3 4
        ((void *)0)
# 41 "src/monitor/sdb/watchpoint.c"
            ;
  free_ = wp_pool;
}
...
WP* new_wp(){
  if(NUM_WP == 0){
    head = &wp_pool[0];
    head->next = 
# 50 "src/monitor/sdb/watchpoint.c" 3 4
                ((void *)0)
# 50 "src/monitor/sdb/watchpoint.c"
                    ;
    free_ = &wp_pool[1];
    NUM_WP += 1;
    return head;
...
# 56 "src/monitor/sdb/watchpoint.c"
                 , "ERROR : No resources in wp pool!\n");
    
# 57 "src/monitor/sdb/watchpoint.c" 3 4
   ((void) sizeof ((
# 57 "src/monitor/sdb/watchpoint.c"
   0
# 57 "src/monitor/sdb/watchpoint.c" 3 4
...
# 57 "src/monitor/sdb/watchpoint.c"
   "0"
# 57 "src/monitor/sdb/watchpoint.c" 3 4
   , "src/monitor/sdb/watchpoint.c", 57, __extension__ __PRETTY_FUNCTION__); }))
# 57 "src/monitor/sdb/watchpoint.c"
            ;
  }
  else{
    WP *tmp = head;
    while(tmp->next != 
# 61 "src/monitor/sdb/watchpoint.c" 3 4
                      ((void *)0)
# 61 "src/monitor/sdb/watchpoint.c"
                          ){
      tmp = tmp->next;
    }
    tmp->next = free_;
...
# 76 "src/monitor/sdb/watchpoint.c" 3 4
 _Bool 
# 76 "src/monitor/sdb/watchpoint.c"
      success = 
# 76 "src/monitor/sdb/watchpoint.c" 3 4
                0
# 76 "src/monitor/sdb/watchpoint.c"
...
# 78 "src/monitor/sdb/watchpoint.c"
 "success"
# 78 "src/monitor/sdb/watchpoint.c" 3 4
 , "src/monitor/sdb/watchpoint.c", 78, __extension__ __PRETTY_FUNCTION__); }))
# 78 "src/monitor/sdb/watchpoint.c"
                ;
...
void display_wp(){
    ...
    printf("%-8s %-18s %s\n", "Num", "Type", "What");
    while(tmp != 
# 95 "src/monitor/sdb/watchpoint.c" 3 4
                ((void *)0)
# 95 "src/monitor/sdb/watchpoint.c"
                    ){
...
# 110 "src/monitor/sdb/watchpoint.c"
 "N>=1 && N <= NUM_WP"
# 110 "src/monitor/sdb/watchpoint.c" 3 4
 , "src/monitor/sdb/watchpoint.c", 110, __extension__ __PRETTY_FUNCTION__); }))
# 110 "src/monitor/sdb/watchpoint.c"
                            ;
...
# 144 "src/monitor/sdb/watchpoint.c"
        ...
        success = 
# 145 "src/monitor/sdb/watchpoint.c" 3 4
                 0
# 145 "src/monitor/sdb/watchpoint.c"
                      ;
        res = expr(cur->expression, &success);
        
# 147 "src/monitor/sdb/watchpoint.c" 3 4
       ((void) sizeof ((
# 147 "src/monitor/sdb/watchpoint.c"
       success
# 147 "src/monitor/sdb/watchpoint.c" 3 4
       ) ? 1 : 0), __extension__ ({ if (
# 147 "src/monitor/sdb/watchpoint.c"
...
# 147 "src/monitor/sdb/watchpoint.c"
       "success"
# 147 "src/monitor/sdb/watchpoint.c" 3 4
       , "src/monitor/sdb/watchpoint.c", 147, __extension__ __PRETTY_FUNCTION__); }))
# 147 "src/monitor/sdb/watchpoint.c"
                      ;
