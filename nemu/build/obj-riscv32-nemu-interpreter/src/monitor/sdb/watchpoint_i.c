...
WP* new_wp(){
  if(NUM_WP == 0){
    ...
    ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/monitor/sdb/watchpoint.c", 57, __extension__ __PRETTY_FUNCTION__); }));
  }
  else{
    WP *tmp = head;
...
void wp(char * args){
  ...
  ((void) sizeof ((success) ? 1 : 0), __extension__ ({ if (success) ; else __assert_fail ("success", "src/monitor/sdb/watchpoint.c", 78, __extension__ __PRETTY_FUNCTION__); }));
  WP *cur = head;
...
void free_wp(char *args){
  ...
  ((void) sizeof ((N>=1 && N <= NUM_WP) ? 1 : 0), __extension__ ({ if (N>=1 && N <= NUM_WP) ; else __assert_fail ("N>=1 && N <= NUM_WP", "src/monitor/sdb/watchpoint.c", 110, __extension__ __PRETTY_FUNCTION__); }));
  if(N == 1){
    WP *tmp = head;
    head = head->next;
    tmp->next = free_;
...
void difftest_wp(){
    ...
    while(cur != ((void *)0)){
        ...
        ((void) sizeof ((success) ? 1 : 0), __extension__ ({ if (success) ; else __assert_fail ("success", "src/monitor/sdb/watchpoint.c", 147, __extension__ __PRETTY_FUNCTION__); }));
