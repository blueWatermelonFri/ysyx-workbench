...
# 20 "/home/myuser/ysyx/ysyx-workbench/nemu/src/isa/riscv32/include/isa-def.h" 2
...
# 1 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/paddr.h" 1
# 17 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/paddr.h"
...
# 26 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/paddr.h"
uint8_t* guest_to_host(paddr_t paddr);

paddr_t host_to_guest(uint8_t *haddr);

static inline 
# 30 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/paddr.h" 3 4
             _Bool 
# 30 "/home/myuser/ysyx/ysyx-workbench/nemu/include/memory/paddr.h"
...
# 87 "src/monitor/sdb/expr.c"
        ...
        if (ret != 0)
        {
            ...
            do { if (!(0)) { (fflush(
# 91 "src/monitor/sdb/expr.c" 3 4
           stdout
# 91 "src/monitor/sdb/expr.c"
           ), fprintf(
# 91 "src/monitor/sdb/expr.c" 3 4
           stderr
# 91 "src/monitor/sdb/expr.c"
...
# 91 "src/monitor/sdb/expr.c"
           "0"
# 91 "src/monitor/sdb/expr.c" 3 4
           , "src/monitor/sdb/expr.c", 91, __extension__ __PRETTY_FUNCTION__); }))
# 91 "src/monitor/sdb/expr.c"
           ; } } while (0);
        }
    }
...
static 
# 109 "src/monitor/sdb/expr.c" 3 4
      _Bool 
# 109 "src/monitor/sdb/expr.c"
           make_token(char *e)
{
    int position = 0;
    int i;
    ...
    while (e[position] != '\0')
    {
        ...
        do { if (!(nr_token < 65536)) { (fflush(
# 119 "src/monitor/sdb/expr.c" 3 4
       stdout
# 119 "src/monitor/sdb/expr.c"
       ), fprintf(
# 119 "src/monitor/sdb/expr.c" 3 4
       stderr
# 119 "src/monitor/sdb/expr.c"
       , "\33[1;31m" "token count can not larger than 32" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 119 "src/monitor/sdb/expr.c" 3 4
       ((void) sizeof ((
# 119 "src/monitor/sdb/expr.c"
       nr_token < 65536
...
# 119 "src/monitor/sdb/expr.c"
       "nr_token < 65536"
# 119 "src/monitor/sdb/expr.c" 3 4
       , "src/monitor/sdb/expr.c", 119, __extension__ __PRETTY_FUNCTION__); }))
# 119 "src/monitor/sdb/expr.c"
       ; } } while (0);
        for (i = 0; i < (int)(sizeof(rules) / sizeof(rules[0])); i++)
        {
            if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 && pmatch.rm_so == 0)
            {
                ...
                do { printf("\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 127, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); do { extern FILE* log_fp; extern 
# 127 "src/monitor/sdb/expr.c" 3 4
               _Bool 
# 127 "src/monitor/sdb/expr.c"
               log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 127, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); fflush(log_fp); } } while (0); } while (0)
                                                                                      ;
...
# 176 "src/monitor/sdb/expr.c" 3 4
                   ((void) sizeof ((
# 176 "src/monitor/sdb/expr.c"
...
# 176 "src/monitor/sdb/expr.c"
                   "substr_len < sizeof(tokens[nr_token].str)"
# 176 "src/monitor/sdb/expr.c" 3 4
                   , "src/monitor/sdb/expr.c", 176, __extension__ __PRETTY_FUNCTION__); }))
# 176 "src/monitor/sdb/expr.c"
                                                                    ;
...
# 182 "src/monitor/sdb/expr.c" 3 4
                   ((void) sizeof ((
# 182 "src/monitor/sdb/expr.c"
                   substr_len < sizeof(tokens[nr_token].str)
# 182 "src/monitor/sdb/expr.c" 3 4
                   ) ? 1 : 0), __extension__ ({ if (
# 182 "src/monitor/sdb/expr.c"
...
# 182 "src/monitor/sdb/expr.c"
                   "substr_len < sizeof(tokens[nr_token].str)"
# 182 "src/monitor/sdb/expr.c" 3 4
                   , "src/monitor/sdb/expr.c", 182, __extension__ __PRETTY_FUNCTION__); }))
# 182 "src/monitor/sdb/expr.c"
                                                                    ;
        ...
        if (i == (int)(sizeof(rules) / sizeof(rules[0])))
        {
            ...
            return 
# 216 "src/monitor/sdb/expr.c" 3 4
                  0
# 216 "src/monitor/sdb/expr.c"
                       ;
        }
    }

    return 
# 220 "src/monitor/sdb/expr.c" 3 4
          1
# 220 "src/monitor/sdb/expr.c"
              ;
}
# 233 "src/monitor/sdb/expr.c"
...
int check_parentheses(int p, int q)
{
    ...
    if(parentheses != 0){
        do { if (!(0)) { (fflush(
# 345 "src/monitor/sdb/expr.c" 3 4
       stdout
# 345 "src/monitor/sdb/expr.c"
       ), fprintf(
# 345 "src/monitor/sdb/expr.c" 3 4
       stderr
# 345 "src/monitor/sdb/expr.c"
       , "\33[1;31m" "Input expr's parentheses not complete" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 345 "src/monitor/sdb/expr.c" 3 4
       ((void) sizeof ((
# 345 "src/monitor/sdb/expr.c"
       0
...
# 345 "src/monitor/sdb/expr.c"
       "0"
# 345 "src/monitor/sdb/expr.c" 3 4
       , "src/monitor/sdb/expr.c", 345, __extension__ __PRETTY_FUNCTION__); }))
# 345 "src/monitor/sdb/expr.c"
       ; } } while (0);
    }
...
# 361 "src/monitor/sdb/expr.c" 3 4
       ((void) sizeof ((
# 361 "src/monitor/sdb/expr.c"
       0
# 361 "src/monitor/sdb/expr.c" 3 4
       ) ? 1 : 0), __extension__ ({ if (
# 361 "src/monitor/sdb/expr.c"
...
# 361 "src/monitor/sdb/expr.c"
       "0"
# 361 "src/monitor/sdb/expr.c" 3 4
       , "src/monitor/sdb/expr.c", 361, __extension__ __PRETTY_FUNCTION__); }))
# 361 "src/monitor/sdb/expr.c"
                ;
...
# 368 "src/monitor/sdb/expr.c" 3 4
               _Bool 
# 368 "src/monitor/sdb/expr.c"
                    success = 
# 368 "src/monitor/sdb/expr.c" 3 4
                              0
# 368 "src/monitor/sdb/expr.c"
...
# 370 "src/monitor/sdb/expr.c" 3 4
               ((void) sizeof ((
# 370 "src/monitor/sdb/expr.c"
               success
# 370 "src/monitor/sdb/expr.c" 3 4
               ) ? 1 : 0), __extension__ ({ if (
# 370 "src/monitor/sdb/expr.c"
...
# 370 "src/monitor/sdb/expr.c"
               "success"
# 370 "src/monitor/sdb/expr.c" 3 4
               , "src/monitor/sdb/expr.c", 370, __extension__ __PRETTY_FUNCTION__); }))
# 370 "src/monitor/sdb/expr.c"
                              ;
                if(reg_num == 32){
                    return cpu.pc;
...
# 400 "src/monitor/sdb/expr.c" 3 4
           ((void) sizeof ((
# 400 "src/monitor/sdb/expr.c"
           addr >= 0x80000000
# 400 "src/monitor/sdb/expr.c" 3 4
           ) ? 1 : 0), __extension__ ({ if (
# 400 "src/monitor/sdb/expr.c"
...
# 400 "src/monitor/sdb/expr.c"
           "addr >= 0x80000000"
# 400 "src/monitor/sdb/expr.c" 3 4
           , "src/monitor/sdb/expr.c", 400, __extension__ __PRETTY_FUNCTION__); }))
# 400 "src/monitor/sdb/expr.c"
                                      ;
        ...
        switch (tokens[op].type){
            ...
            case DIV:
                do { if (!(val2 != 0)) { (fflush(
# 436 "src/monitor/sdb/expr.c" 3 4
               stdout
# 436 "src/monitor/sdb/expr.c"
               ), fprintf(
# 436 "src/monitor/sdb/expr.c" 3 4
               stderr
# 436 "src/monitor/sdb/expr.c"
               , "\33[1;31m" "Zero cannot be devides" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 436 "src/monitor/sdb/expr.c" 3 4
               ((void) sizeof ((
# 436 "src/monitor/sdb/expr.c"
               val2 != 0
...
# 436 "src/monitor/sdb/expr.c"
               "val2 != 0"
# 436 "src/monitor/sdb/expr.c" 3 4
               , "src/monitor/sdb/expr.c", 436, __extension__ __PRETTY_FUNCTION__); }))
# 436 "src/monitor/sdb/expr.c"
               ; } } while (0);
                return val1 / val2;
            default:
                do { if (!(0)) { (fflush(
# 439 "src/monitor/sdb/expr.c" 3 4
               stdout
# 439 "src/monitor/sdb/expr.c"
               ), fprintf(
# 439 "src/monitor/sdb/expr.c" 3 4
               stderr
# 439 "src/monitor/sdb/expr.c"
               , "\33[1;31m" "not support op %d" "\33[0m" "\n", tokens[op].type)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 439 "src/monitor/sdb/expr.c" 3 4
               ((void) sizeof ((
# 439 "src/monitor/sdb/expr.c"
               0
...
# 439 "src/monitor/sdb/expr.c"
               "0"
# 439 "src/monitor/sdb/expr.c" 3 4
               , "src/monitor/sdb/expr.c", 439, __extension__ __PRETTY_FUNCTION__); }))
# 439 "src/monitor/sdb/expr.c"
               ; } } while (0);
        }
    }
...
word_t expr(char *e, 
# 445 "src/monitor/sdb/expr.c" 3 4
                    _Bool 
# 445 "src/monitor/sdb/expr.c"
                         *success)
{
    ...
    {
        *success = 
# 450 "src/monitor/sdb/expr.c" 3 4
                  0
# 450 "src/monitor/sdb/expr.c"
                       ;
        return 0;
    }


    do { if (!(nr_token - 1 >= 0)) { (fflush(
# 455 "src/monitor/sdb/expr.c" 3 4
   stdout
# 455 "src/monitor/sdb/expr.c"
   ), fprintf(
# 455 "src/monitor/sdb/expr.c" 3 4
   stderr
# 455 "src/monitor/sdb/expr.c"
   , "\33[1;31m" "expression is bad!" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); 
# 455 "src/monitor/sdb/expr.c" 3 4
   ((void) sizeof ((
# 455 "src/monitor/sdb/expr.c"
   nr_token - 1 >= 0
...
# 455 "src/monitor/sdb/expr.c"
   "nr_token - 1 >= 0"
# 455 "src/monitor/sdb/expr.c" 3 4
   , "src/monitor/sdb/expr.c", 455, __extension__ __PRETTY_FUNCTION__); }))
# 455 "src/monitor/sdb/expr.c"
   ; } } while (0);
    word_t res = eval(0, nr_token - 1);
    *success = 
# 457 "src/monitor/sdb/expr.c" 3 4
              1
# 457 "src/monitor/sdb/expr.c"
                  ;
