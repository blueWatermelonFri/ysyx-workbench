...
void init_regex()
{
    ...
    for (i = 0; i < (int)(sizeof(rules) / sizeof(rules[0])); i++)
    {
        ...
        if (ret != 0)
        {
            ...
            do { if (!(0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "regex compilation failed: %s\n%s" "\33[0m" "\n", error_msg, rules[i].regex)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/monitor/sdb/expr.c", 91, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
        }
    }
}
...
static _Bool make_token(char *e)
{
    ...
    while (e[position] != '\0')
    {
        do { if (!(nr_token < 65536)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "token count can not larger than 32" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((nr_token < 65536) ? 1 : 0), __extension__ ({ if (nr_token < 65536) ; else __assert_fail ("nr_token < 65536", "src/monitor/sdb/expr.c", 119, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
        for (i = 0; i < (int)(sizeof(rules) / sizeof(rules[0])); i++)
        {
            if (regexec(&re[i], e + position, 1, &pmatch, 0) == 0 && pmatch.rm_so == 0)
            {
                ...
                do { printf("\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 127, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); do { extern FILE* log_fp; extern _Bool log_enable(); if (log_enable()) { fprintf(log_fp, "\33[1;34m" "[%s:%d %s] " "match rules[%d] = \"%s\" at position %d with len %d: %.*s" "\33[0m" "\n", "src/monitor/sdb/expr.c", 127, __func__, i, rules[i].regex, position, substr_len, substr_len, substr_start); fflush(log_fp); } } while (0); } while (0);
                position += substr_len;
                ...
                case RBRACKET:
                    ...
                    break;
                case NUMBER:
                    ((void) sizeof ((substr_len < sizeof(tokens[nr_token].str)) ? 1 : 0), __extension__ ({ if (substr_len < sizeof(tokens[nr_token].str)) ; else __assert_fail ("substr_len < sizeof(tokens[nr_token].str)", "src/monitor/sdb/expr.c", 176, __extension__ __PRETTY_FUNCTION__); }));
                    tokens[nr_token].type = NUMBER;
                    strncpy(tokens[nr_token].str, substr_start, substr_len);
                    tokens[nr_token].str[substr_len] = '\0';
                    break;
                case HEXANUMBER:
                    ((void) sizeof ((substr_len < sizeof(tokens[nr_token].str)) ? 1 : 0), __extension__ ({ if (substr_len < sizeof(tokens[nr_token].str)) ; else __assert_fail ("substr_len < sizeof(tokens[nr_token].str)", "src/monitor/sdb/expr.c", 182, __extension__ __PRETTY_FUNCTION__); }));
...
int check_parentheses(int p, int q)
{
    ...
    if(parentheses != 0){
        do { if (!(0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "Input expr's parentheses not complete" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/monitor/sdb/expr.c", 345, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
    }
...
word_t eval (int p, int q)
{
    if (p > q)
    {
        ...
        ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/monitor/sdb/expr.c", 361, __extension__ __PRETTY_FUNCTION__); }));
    }
    else if (p == q)
    {
        switch (tokens[p].type){
            case REG:
                ...
                ((void) sizeof ((success) ? 1 : 0), __extension__ ({ if (success) ; else __assert_fail ("success", "src/monitor/sdb/expr.c", 370, __extension__ __PRETTY_FUNCTION__); }));
                if(reg_num == 32){
                    return cpu.pc;
                }
    ...
    else
    {
        ...
        if(tokens[op].type == DEREF){
            ...
            ((void) sizeof ((addr >= 0x80000000) ? 1 : 0), __extension__ ({ if (addr >= 0x80000000) ; else __assert_fail ("addr >= 0x80000000", "src/monitor/sdb/expr.c", 400, __extension__ __PRETTY_FUNCTION__); }));
        ...
        switch (tokens[op].type){
            ...
            case TK_NEQ:
                ...
                break;
            case DIV:
                do { if (!(val2 != 0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "Zero cannot be devides" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((val2 != 0) ? 1 : 0), __extension__ ({ if (val2 != 0) ; else __assert_fail ("val2 != 0", "src/monitor/sdb/expr.c", 436, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
                return val1 / val2;
            default:
                do { if (!(0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "not support op %d" "\33[0m" "\n", tokens[op].type)); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((0) ? 1 : 0), __extension__ ({ if (0) ; else __assert_fail ("0", "src/monitor/sdb/expr.c", 439, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
        }
    }
    return 0;
}
word_t expr(char *e, _Bool *success)
{
    ...
    do { if (!(nr_token - 1 >= 0)) { (fflush(stdout), fprintf(stderr, "\33[1;31m" "expression is bad!" "\33[0m" "\n")); extern FILE* log_fp; fflush(log_fp); extern void assert_fail_msg(); assert_fail_msg(); ((void) sizeof ((nr_token - 1 >= 0) ? 1 : 0), __extension__ ({ if (nr_token - 1 >= 0) ; else __assert_fail ("nr_token - 1 >= 0", "src/monitor/sdb/expr.c", 455, __extension__ __PRETTY_FUNCTION__); })); } } while (0);
