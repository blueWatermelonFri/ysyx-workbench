...
void strace(int a0, int a1, int a2, int a3, int return_value ){
    ...
    case 4:  Log("SYSCALL name : SYS_write, ARG0 is %d,  ARG1 is %d, ARG2 is %d, Return is %d", a1, a2, a3, return_value);  break;
    case 9:  Log("SYSCALL name : SYS_brk, ARG0 is %d,  ARG1 is %d, ARG2 is %d, Return is %d", a1, a2, a3, return_value);  break;
