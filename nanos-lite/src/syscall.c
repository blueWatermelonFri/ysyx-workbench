...
void strace(uintptr_t a0, uintptr_t a1, uintptr_t a2, uintptr_t a3, uintptr_t return_value){
  switch (a0) {
    ...
    case 4:  Log("SYS_write, arg1 : %d, arg2 : %d, arg3 : %d, return value is %d", a1, a2, a3, return_value);  break;
    case 9:  Log("SYS_sbrk, arg1 : %d, arg2 : %d, arg3 : %d, return value is %d", a1, a2, a3, return_value);  break;
